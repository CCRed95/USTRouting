...
namespace Material.Design.Text
{
	...
	public partial class TextualStyle : Freezable
	{
		public static readonly DependencyProperty ForegroundDescriptorProperty = DP.Register(new Meta<TextualStyle, AbstractMaterialDescriptor>(Static.Descriptors.WhiteDescriptor));
		...
		public static readonly DependencyProperty TextRotationProperty = DP.Register(new Meta<TextualStyle, TextRotation> { Flags = FlexControl.FXR });
