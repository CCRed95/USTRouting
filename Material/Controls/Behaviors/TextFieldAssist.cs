...
namespace Material.Controls.Behaviors
{
	...
	public static class TextFieldAssist
	{
		...
		public static readonly DependencyProperty HintProperty = DependencyProperty.RegisterAttached(
				"Hint",
				typeof(string),
				typeof(Controls.TextFieldAssist),
		...
		public static readonly DependencyProperty TextProperty = DependencyProperty.RegisterAttached(
				"Text", typeof(string), typeof(Controls.TextFieldAssist), new PropertyMetadata(default(string), TextPropertyChangedCallback));

		private static readonly DependencyPropertyKey IsNullOrEmptyPropertyKey = DependencyProperty.RegisterAttachedReadOnly(
				"IsNullOrEmpty", typeof(bool), typeof(Controls.TextFieldAssist), new PropertyMetadata(true));
