...
namespace Material.Controls.Behaviors
{
	...
	{
		//public static readonly DependencyProperty StateBTWProperty = DependencyProperty.RegisterAttached(
		//	"StateBTW",
		//	typeof(string),
		//	typeof(StateAssist),
		//	new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, StateBTWChanged));

		//public static string GetStateBTW(DependencyObject obj)
		//	=> (string)obj.GetValue(StateBTWProperty);

		//public static void SetStateBTW(DependencyObject obj, string value)
		//	=> obj.SetValue(StateBTWProperty, value);

		//internal static void StateBTWChanged(DependencyObject target, DependencyPropertyChangedEventArgs args)
		//{
