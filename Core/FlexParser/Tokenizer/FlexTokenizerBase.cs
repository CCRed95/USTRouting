...
namespace Core.FlexParser.Tokenizer
{
	public class FlexTokenizerBase
	{
		...
		public FlexTokenizerBase(string _expression)
		{
		...
		public FlexTokenizerFrame GetFrame() => new FlexTokenizerFrame(currentIndex);
