...
namespace Core.Helpers.DependencyHelpers
{
	public static class DP
	{
		...
		{
			if(i == null)
				throw new ArgumentNullException(nameof(i), $"Get dependency property \'{dp.Name}\' value failed." +
		...
		{
			if(i == null)
				throw new ArgumentNullException(nameof(i), $"Set dependency property \'{dp.Name}\' value failed." +
				                                           $"Object cannot be null.");
			i.SetValue(dp, value);
		}
		/// <summary>
		...
		internal static string GetPropertyName(string autoFieldName)
		{
			...
			//var propertyName = autoFieldName.Replace("Property", string.Empty);
			var propertyName = autoFieldName.Substring(0, autoFieldName.Length - "Property".Length);
			return propertyName;
		}
		internal static string GetReadOnlyPropertyName(string autoFieldName)
		{
			...
			var propertyName = autoFieldName.Substring(0, autoFieldName.Length - "PropertyKey".Length);
			return propertyName;
		}
	}

	public static class DPExt
	{
		[MethodImpl(MethodImplOptions.NoInlining)]
